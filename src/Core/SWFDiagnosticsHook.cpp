...
namespace HookCrashers::Core {
	namespace {
		constexpr uintptr_t kSWFMovieCtorRva = 0x120DF0; // updated // VA 0x8FEC70 with IDA base 0x7E0000.
		constexpr uintptr_t kSWFSceneParseHeaderRva = 0x125440; // updated // VA 0x9032C0 with image base 0x7E0000.
		constexpr uintptr_t kSWFNodeCtorLoadCOK6Rva = 0xFD7C0; // updated // VA 0x8DB7A0 with IDA base 0x7E0000.
